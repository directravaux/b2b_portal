                ...
                <div class="col-lg-3 col-md-3 col-6 v_middle">
                    <div class="logo">
                        <a href="<?php echo e(url('/')); ?>">
                            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="logo image" class="img-fluid">
                        </a>
                    </div>
                </div>
                <!-- end /.col-md-3 -->
                    ...
                    <?php if(Auth::check()): ?>
                        ...
                        <div class="author-area">
                            <?php if($userRole=="client"): ?>
                                <a href="<?php echo e(route('client.vendor')); ?>" class="author-area__seller-btn inline">Become a Vendor</a>
                            <?php endif; ?>
                                                ...
                                                <div class="notification">
                                                    <div class="notification__info">
                                                        <div class="info_avatar">
                                                            <img src="<?php echo e(asset('images/notification_head.png')); ?>" alt="">
                                                        </div>
                                                        <div class="info">
                                                            <p>
                                            ...
                                            <div class="messages">
                                                <a href="message.html" class="message recent">
                                                    <div class="message__actions_avatar">
                                                        <div class="avatar">
                                                            <img src="<?php echo e(asset('images/notification_head4.png')); ?>" alt="">
                                                        </div>
                                                    </div>
                                                    <!-- end /.actions -->
                                            ...
                                            <div class="cart_area">
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="<?php echo e(asset('images/capro1.jpg')); ?>" alt="cart product thumbnail">
                                                        </div>
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <div class="cat">
                                                                <a href="#">
                                                                    <img src="<?php echo e(asset('images/catword.png')); ?>" alt="">Wordpress</a>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="author-author__info inline has_dropdown">
                                <div class="author__avatar">
                                    <img src="<?php echo e($userPhoto); ?>" alt="user avatar" height="50px" width="50px">
                                </div>
                                ...
                                <div class="dropdowns dropdown--author">
                                    <ul>
                                        <li>
                                            <a href='<?php echo e(url("$userRole")); ?>'>
                    ...
                    <?php else: ?>
                        ...
                        <div class="author-area not_logged_in">
                                        ...
                                        <div class="dropdowns dropdown--cart">
                                            <div class="cart_area">
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="<?php echo e(asset('images/images/capro1.jpg')); ?>"
                                                        ...
                                                        <div class="info">
                                                            ...
                                                            <div class="cat">
                                                                <a href="#">
                                                                    <img src="<?php echo e(asset('images/images/catword.png')); ?>"
                                                                         alt="">Wordpress</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="cart_product">
                                                    <div class="product__info">
                                                        <div class="thumbn">
                                                            <img src="<?php echo e(asset('images/images/capro2.jpg')); ?>"
                                                                 alt="cart product thumbnail">
                                                        </div>
                            ...
                            <div class="pull-right join">
                                <a href="<?php echo e(route('register')); ?>" class="btn btn--round btn-secondary  btn--xs">Join Now</a>
                                <a href="<?php echo e(route('login')); ?>" class="btn btn--round btn--xs">Login</a>
                            </div>
                        </div>
                        <!-- end .author-area -->
                        ...
                        <div class="mobile_content">
                            ...
                            <div class="offcanvas-menu closed">
                                ...
                                <div class="author-author__info">
                                    <div class="author__avatar v_middle">
                                        <img src="<?php echo e(asset('images/usr_avatar.png')); ?>" alt="user avatar">
                                    </div>
                                    <div class="autor__info v_middle">
                                        <p class="name">
                                            Welcome Guest
...
<!-- end /.menu-area -->
<?php /**PATH /Applications/MAMP/htdocs/b2b_portal/resources/views/layout/common/header.blade.php ENDPATH**/ ?>