		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="pricing red">
					...
					<a href="<?php echo e(route('client.price')); ?>" class="pricing--btn btnSubmit">Get Started Plan</a>
					<!-- end /.pricing--btn -->
				</div>
				<!-- end /.pricing -->
			</div>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/b2b_portal/resources/views/client/price.blade.php ENDPATH**/ ?>