...
<div class="container">
        ...
        <script src="<?php echo e(asset('pages/js/select2.js')); ?>" type="text/javascript"></script>


		<!--Store Description JS -->
        <script src="<?php echo e(asset('pages/js/bootstrap-maxlength.js')); ?>" type="text/javascript"></script>


		<!-- Emergency Modul - Switch Button JS -->
        <script src="<?php echo e(asset('pages/js/form-widgets.js')); ?>" type="text/javascript"></script>
...
</html><?php /**PATH /Applications/MAMP/htdocs/b2b_portal/resources/views/vendor/wizard.blade.php ENDPATH**/ ?>