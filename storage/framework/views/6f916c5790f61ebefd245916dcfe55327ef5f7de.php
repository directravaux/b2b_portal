...
<section class="dashboard-area">
    <?php $__env->startSection('vendordashboardarea'); ?>
        <?php echo $__env->make('layout.common.vendordashboardarea', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->yieldSection(); ?>
        <div class="dashboard_contents">
            <div class="container">
                ...
                <!-- end /.row -->
                <form role="form" method="POST" action="<?php echo e(route('vendor.profile')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-lg-6">
                                    ...
                                    <div class="information_wrapper form--fields">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-sm-8">
                                                <div class="form-group">
                                                    <input id="enterprise" name="enterprise" value="<?php echo e(old('enterprise')); ?>" type="text" class="text_field" placeholder="Enter your enterprise">
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-sm-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?php echo e(route('vendor.store')); ?>" target="_blank">
                                                <?php echo e($user->store_name); ?>
                                    ...
                                    <div class="information_wrapper form--fields">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="custom-radio">
                                                <input type="radio" id="payment_paypal" class="role" name="payment_option" value="paypal" <?php if(old('payment_option', (isset($user->payment_option)) ? $user->payment_option:'')=='paypal'): ?> checked <?php endif; ?>>
                                                <label for="payment_paypal">
                                                <span class="circle"></span>Paypal</label>

                                                <input type="radio" id="payment_option_card" class="role" name="payment_option" value="card" <?php if(old('payment_option', (isset($user->payment_option)) ? $user->payment_option:'')=='card'): ?> checked <?php endif; ?>>
                                                <label for="payment_option_card">
                                                <span class="circle"></span>Credit Card</label>

                                                <input type="radio" id="payment_option_bank" class="role" name="payment_option" value="bank" <?php if(old('payment_option', (isset($user->payment_option)) ? $user->payment_option:'')=='bank'): ?> checked <?php endif; ?>>
                                                <label for="payment_option_bank">
                                                <span class="circle"></span>Bank Account</label>
                                            </div>
                                            <span class="mcolor4">
                                                <?php echo e($errors->first('payment_option')); ?>
                                        ...
                                        <div class="payment_info modules__content cardInfo">
                                            <div class="form-group required">
                                                ...
                                                <input id="card_number" name="card_number" value="<?php echo e(old('card_number',$user->card_number)); ?>" type="text" class="text_field numeric" placeholder="Enter your card number here..." maxlength="16">
                                                <span class="mcolor4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="select-wrap select-wrap2">
                                                            <select name="card_exp_month" id="card_exp_month" class="text_field">
                                                                ...
                                                                <?php if(old('card_exp_month', (isset($user->card_exp_month)) ? $user->card_exp_month:'')==$key): ?>
                                                                <option value="<?php echo e($key); ?>" selected><?php echo e($month); ?></option>
                                                                <?php else: ?>
                                                            ...
                                                            <span class="mcolor4">
                                                                <?php echo e($errors->first('card_exp_month')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-wrap select-wrap2">
                                                            <select name="card_exp_year" id="card_exp_year" class="text_field">
                                                                ...
                                                                <?php if(old('card_exp_year', (isset($user->card_exp_year)) ? $user->card_exp_year:'')==$key): ?>
                                                                <option value="<?php echo e($key); ?>" selected><?php echo e($year); ?></option>
                                                                <?php else: ?>
                                                                <option value="<?php echo e($key); ?>"><?php echo e($year); ?></option>
                                                                <?php endif; ?>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                            <span class="mcolor4">
                                                                <?php echo e($errors->first('card_exp_year')); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group required">
                                                        ...
                                                        <input id="card_cvv_code" name="card_cvv_code" value="<?php echo e(old('card_cvv_code',$user->card_cvv_code)); ?>" type="text" class="text_field numeric" placeholder="Enter your CVV Code" maxlength="3">
                                                        <span class="mcolor4">
                                                            <?php echo e($errors->first('card_cvv_code')); ?>
                                        ...
                                        <div class="payment_info modules__content bankInfo">
                                            <div class="form-group required">
                                                ...
                                                <input id="bank_name" name="bank_name" value="<?php echo e(old('bank_name',$user->bank_name)); ?>" type="text" class="text_field" placeholder="Enter your card number here...">
                                                <span class="mcolor4">
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <input id="bank_accont_no" name="bank_accont_no" value="<?php echo e(old('bank_accont_no',$user->bank_accont_no)); ?>" type="text" class="text_field numeric" placeholder="Enter your card number here...">
                                                <span class="mcolor4">
                                                    <?php echo e($errors->first('bank_accont_no')); ?>
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <input id="bank_ifsc_no" name="bank_ifsc_no" value="<?php echo e(old('bank_ifsc_no',$user->bank_ifsc_no)); ?>" type="text" class="text_field" placeholder="Enter your card number here...">
                                                <span class="mcolor4">
                                                    <?php echo e($errors->first('bank_ifsc_no')); ?>
                                    ...
                                    <div class="information_wrapper">
                                        ...
                                        <div class="profile_image_area">
                                        	<?php if($user->user_photo !=''): ?>
                                        		<img src="<?php echo e($userPhoto); ?>" height="100px" width="100px">
                                        	<?php else: ?>
                                            	<img src="<?php echo e(asset('images/authplc.png')); ?>">
                                            <?php endif; ?>
                                            <div class="img_info">
                                        ...
                                        <div class="prof_img_upload">
                                            ...
                                            <?php if($user->banner_photo !='' && $user->user_role=='vendor'): ?>
                                        		<img src="<?php echo e($bannerPhoto); ?>" height="200px" width="495px">
                                        	<?php else: ?>
                                            	<img src="<?php echo e(asset('images/cvrplc.jpg')); ?>">
                                            <?php endif; ?>
                                            ...
                                            <div class="upload_title">
												...
												<span class="mcolor4">
													<?php echo e($errors->first('banner_photo')); ?>
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/b2b_portal/resources/views/vendor/index.blade.php ENDPATH**/ ?>