								...
								<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										<h3 class="kt-portlet__head-title">
											Hello Username<br>
											<small>
												This is a Demo Wizard for cratinom Store on Diret Travaux, we will join you in every step for create you best store
											</small>
										</h3>
									</div>
												...
												<ul class="kt-nav">
													<li class="kt-nav__item">
														<a href="#" class="kt-nav__link">
															...
															<span class="kt-nav__link-text">Continue Later</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="#" class="kt-nav__link">
															<i class="kt-nav__link-icon flaticon2-power"></i>
															<span class="kt-nav__link-text" data-toggle="modal" data-target="#kt_modal_5">Save & exit</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="#" class="kt-nav__link">
						...
						<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
							...
							<form class="kt-form" id="kt_form">
								...
								<div class="kt-wizard-v1__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
									...
									<div class="kt-heading kt-heading--md">About the Store </div>
								...
								<div class="kt-wizard-v1__form">
												...
												<div class="kt-wizard-v1__review">
													<div class="kt-wizard-v1__review-item">
														...
														<span class="form-text text-muted">
															Availeble and Choosen !
															<i class="la la-check checkgreen"></i> 
														</span>
													</div>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-xl-6">
											<div class="form-group">
												<label>Upload Your Photo or Logo</label>
												<div class="col-xl-6">
													<div class="kt-avatar kt-avatar--outline kt-avatar--circle" id="kt_user_avatar_3">
														<div class="kt-avatar__holder" style="background-image: url(img/mystery_avatar.png)"></div>
													...
													<span class="form-text text-muted">Allowed file types: png, jpg, jpeg. Max filesize: 2MiB</span>
												</div>
											</div>
										</div>
										<div class="col-xl-6">
											<div class="form-group">
												...
												<div class="dropzone dropzone-default" id="kt_dropzone_1">
													<div class="dropzone-msg dz-message needsclick">
														<h3 class="dropzone-msg-title">Drop your Banner here or click to upload.</h3>
														<span class="dropzone-msg-desc">Ideal dimension of the banner is  <strong>750x350px</strong> Max filesize: 5MiB</span>
													</div>
												</div>
												<span class="form-text text-muted">The Banner is one Cover For Your Store Page and it shoul be nice photo for attract the clients.</span>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label>Discribe Your Store</label>
										<textarea name="description" class="form-control" id="kt_maxlength_5" minlength="350" maxlength="700" placeholder="" rows="6"></textarea>
										<span class="form-text text-muted">Discribe Your Store In the Best for be more atractive to you futur clients.</span>
									</div>
									<div class="row">
										<div class="col-xl-6">
											<div class="form-group">
												<label>How Many Years You aHave Expiriance ?</label>
												<select name="expiriance" class="form-control">
									...
									<div class="row">
										<div class="col-xl-6">
											<div class="form-group">
												...
												<select name="wfunction" class="form-control">
													<option value="">Select</option>
										...
										<div class="col-xl-6">
											<div class="form-group">
												...
												<select name="otherp" class="form-control">
													<option value="">Select</option>
									...
									<div class="form-group">
											...
											<div class="">
												<select class="form-control kt-select2" id="kt_select2_9_0" name="param" multiple>
													<option></option>
								...
								<div class="alert-text">
									The Metronic Datatable component supports local or remote data source. For the local 
										...
										<div class="col-xl-4">
											...
											<label>Limiting Selections</label>
											<div class="">
												<select class="form-control kt-select2" id="kt_select2_9_1" name="param" multiple>
													<option></option>
													<optgroup label="Alaskan/Hawaiian Time Zone">
														<option value="AK">Alaska</option>
														<option value="HI">Hawaii</option>
							...
							<div class="kt-form__section kt-form__section--first">
								<div class="kt-wizard-v1__form">
																...
																<div class="form-group row">
																	<label class="col-3 col-form-label">Login verification</label>
																	<div class="col-9">
																		<button type="button" class="btn btn-outline-primary btn-sm kt-margin-t-5 kt-margin-b-5" data-toggle="modal" data-target="#kt_modal_1">Setup login verification</button>
																		<span class="form-text text-muted">
																			After you log in, you will be asked for additional information to confirm your identity and protect your account from being compromised.
																			<a href="#" class="kt-link">Learn more</a>.
																		</span>
