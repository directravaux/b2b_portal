            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <li>
                                <a href="{{url('/a-propos-de-nous')}}">À Propos de Nous</a>
                            </li>
                            <li>
                                <a href="{{url('/comment-ca-marche')}}">Comment Ça Marche</a>
                            </li>
                            <li>
                                <a href="{{url('/rejoignez-nous')}}">Rejoignez Nous</a>
                            </li>
                            <li>
                                <a href="#">Évènements</a>
                            </li>
                    ...
                    <div class="footer-menu">
                        ...
                        <ul>
                            <li>
                                <a href="{{url('/faqs-clients')}}">FAQS Clients</a>
                            </li>
                            <li>
                                <a href="{{url('/faqs-professionnel')}}">FAQS Entreprises</a>
                            </li>
                            <li>
                                <a href="{{url('/#')}}">Forum D'Assistance</a>
                            </li>
                            <li>
                                <a href="{{url('/politique-de-confidentialite')}}">Confidentialité</a>
                            </li>
                            <li>
                                <a href="{{url('/politique-de-cookies')}}">Politique De Cookies</a>
                            </li>
                            <li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="newsletter">
                        <h4 class="footer-widget-title text--white">Newsletter</h4>
                            <p>
                                Cette information sera protégée conformément à la notre <a href="{{url('/politique-de-confidentialite')}}">Politique de Confidentialité</a> dans la mesure où elle constitue des informations personnelles.
                            </p>
